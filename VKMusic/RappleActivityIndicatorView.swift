...
/**
 ...
 - RappleProgressBarFillColorKey    white
 */
public let RappleModernAttributes : [String:AnyObject] = [RappleTintColorKey:UIColor.black, RappleIndicatorStyleKey:RappleStyleCircle as AnyObject, RappleScreenBGColorKey:UIColor(white: 0.0, alpha: 0.2), RappleProgressBarColorKey: UIColor.lightGray, RappleProgressBarFillColorKey: UIColor.white]
