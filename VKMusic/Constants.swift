...
//Local APIS URL
let SERVER_RMQ_URL = "amqp://yaroslav:dukalis@192.168.1.69"
let RMQConnection_URI = "amqp://yaroslav:dukalis@192.168.1.69"

let LOCAL_API_SERVER_ADDRESS = "http://192.168.1.69:8080/"
