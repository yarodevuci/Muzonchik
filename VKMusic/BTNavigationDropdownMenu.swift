...
open class BTNavigationDropdownMenuView: UIView {
    ...
    public init(containerView: UIView, title: String, items: [AnyObject]) {

        // Get titleSize
       // let titleSize = (title as NSString).size(attributes: [NSFontAttributeName:self.configuration.navigationBarTitleFont])
        
        // Set frame
        //let frame = CGRect(x: (UIScreen.main.bounds.size.width / 2) - (titleSize.width + 10), y: 10, width: titleSize.width + (self.configuration.arrowPadding + self.configuration.arrowImage.size.width)*2, height: 64)
        //let frame = CGRect(x: (UIScreen.main.bounds.size.width / 2) - (titleSize.width + 10), y: 0, width: titleSize.width + (self.configuration.arrowPadding + self.configuration.arrowImage.size.width), height: CGFloat(64))
        
        let frame = CGRect(x: 0, y: 5, width: UIScreen.main.bounds.size.width, height: 59)
        ...
        self.menuButton.addTarget(self, action: #selector(BTNavigationDropdownMenuView.menuButtonTapped(_:)), for: UIControlEvents.touchUpInside)
        ...
        let menuWrapperBounds = UIScreen.main.bounds
        
        // Set up DropdownMenu
        self.menuWrapper = UIView(frame: CGRect(x: 0, y: 0, width: menuWrapperBounds.width, height: menuWrapperBounds.height))
        ...
        let backgroundTapRecognizer = UITapGestureRecognizer(target: self, action: #selector(BTNavigationDropdownMenuView.hideMenu));
    ...
    override open func layoutSubviews() {
        ...
        self.menuWrapper.frame.origin.y = 64
    ...
    func setupDefaultConfiguration() {
        ...
        self.cellBackgroundColor = UIColor.blue
        self.cellSeparatorColor = UIColor.white
        self.cellTextLabelColor = UIColor.blue
